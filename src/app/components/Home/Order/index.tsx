...
const About = () => {
  return (
    <section
      id="order"
      className="py-20 bg-[url('/images/order/order.jpg')] bg-cover bg-center bg-no-repeat relative -z-10"
    >
      <div
          ...
          <div className="flex flex-col gap-5 justify-center px-6 lg:px-0">
            ...
            <div className="mx-auto lg:mx-0">
              <Link
                ...
                target="_blank"
              >
                <button className="text-white text-xl font-medium py-4 px-8 rounded-full transition duration-300 border border-green-primary bg-green-primary hover:bg-transparent hover:cursor-pointer hover:text-green-primary hover:border-green-primary">
                  Our Location
                </button>
              </Link>
            </div>
